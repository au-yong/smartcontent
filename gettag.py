...
def evaluate(encoder, decoder, sentence, max_length=MAX_LENGTH):
    with torch.no_grad():
        ...
        input_tensor = tensorFromSentence(input_lang, 'cats')
        input_length = input_tensor.size()[0]
        encoder_hidden = encoder.initHidden()
...
# loss_count = trainIters(encoder1, attn_decoder1, 100, print_every=5000)
output_words, attentions = evaluate(encoder1,attn_decoder1,'tabby cat')
print("Cat is you best companies.", "#".join(output_words[:7]))
